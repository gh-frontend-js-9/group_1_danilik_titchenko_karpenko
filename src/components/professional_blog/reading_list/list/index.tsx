...
// set up for Carousel
// centerMode centerSlidePercentage={20} showStatus={false} showIndicators={false} showThumbs={false}
...
export default function () {
    ...
    return (
        <BlockWrapper indent>
            <ReadingListHeader title="Reading list"></ReadingListHeader>
            <Carousel centerMode centerSlidePercentage={width} showStatus={false} showIndicators={false} showThumbs={false} emulateTouch={true}>
                {
                    test.title.map((value, index) => {
                        return (
                            <Card key={index}>
                                {/* https://picsum.photos/width/height */}
                                <Image className="text_align-center" src="https://picsum.photos/200/250" alt="random photo"></Image>
